...
class _QImagePickerState extends State<QImagePicker> {
  ...
  Future<String> uploadToLaravel(String filePath) async {
    ...
    final res = await Dio().post(
      'http://192.168.1.6:8080/api/pembayaran/store',
      data: formData,
    );
  ...
  Future<void> browseFile() async {
    ...
    imageUrl = await uploadToLaravel(filePath);
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            ...
                            backgroundColor: Color.fromARGB(255, 57, 216, 8),
                          ),
